    ...
    <div className="projeck">
      ...
      <ul className="projeck__inner">
        <li className="projeck__item">
          ...
          <p className="projeck_item__text">Tech stack : JavaScript, SASS, React, Tailwind</p>
          <div className="flex justify-between">
            <a className="projeck__link" href="https://fabulous-sunshine-d4731a.netlify.app/">
              <img src={link} alt="link" />
              Live Preview
            </a>
            <a className="projeck__link" href="https://github.com/Burxoniddin000/twister-.git">
        ...
        <li className="projeck__item">
          ...
          <p className="projeck_item__text">Tech stack : Html, JavaScript, Css, SASS</p>
          <div className="flex justify-between">
            <a className="projeck__link" href="https://classy-moonbeam-6af94a.netlify.app/login.html">
              <img src={link} alt="link" />
              Live Preview
            </a>
            <a className="projeck__link" href="https://github.com/Burxoniddin000/onlayn_magazin.git">
              <img src={github} alt="github" />
              View Code
            </a>
          </div>
